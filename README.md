...
- 📱 **旧手机 / 旧电脑就能当影音服务器，内外网通吃，免 NAS 免云服务器** —— 一台闲置的安卓手机或旧电脑跑起 MediaForge，给它一个固定局域网 IP，局域网内电视 / 手机 / 各类播放器直接连；再把这个地址映射到公网（如 ddnsto 等内网穿透），**在外网也能通过 302 直链播放**，播放直连网盘源站、不吃你的家庭带宽。不用买 NAS、不用租云服务器，把吃灰的旧设备变成你的私人影音服务器。
...
| 入门 | 各平台 | 配置指南 | 关于 |
|---|---|---|---|
| [特性详解](https://github.com/lipin113/mediaforge/wiki/Features) | [PC 桌面端](https://github.com/lipin113/mediaforge/wiki/Desktop) | [登录与激活](https://github.com/lipin113/mediaforge/wiki/Login-and-Activation) · [添加网盘](https://github.com/lipin113/mediaforge/wiki/Add-Cloud-Drives) | [联系与支持](https://github.com/lipin113/mediaforge/wiki/Support) |
| [安装部署](https://github.com/lipin113/mediaforge/wiki/Installation) · [Docker/Linux](https://github.com/lipin113/mediaforge/wiki/Docker-and-Linux) | [安卓 Android](https://github.com/lipin113/mediaforge/wiki/Android) | [自动重命名](https://github.com/lipin113/mediaforge/wiki/Auto-Rename) · [STRM 库](https://github.com/lipin113/mediaforge/wiki/STRM-Library) | [开源致谢](https://github.com/lipin113/mediaforge/wiki/Credits) |
| [快速上手](https://github.com/lipin113/mediaforge/wiki/Quick-Start) | [iOS](https://github.com/lipin113/mediaforge/wiki/iOS) | [NFO 与豆瓣](https://github.com/lipin113/mediaforge/wiki/NFO-and-Douban) · [Emby 配置](https://github.com/lipin113/mediaforge/wiki/Emby-Setup) | [声明](https://github.com/lipin113/mediaforge/wiki/Disclaimer) |
